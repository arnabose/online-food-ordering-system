...
<!-------sending signup information to database ------>
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($email_count>0){
            ...
            if($password === $cpassword){
                $insert_query = "insert into admin(fname, lname, email, phone, password) VALUES('$first_name','$last_name','$email','$phone','$encrpt_pwd')";
